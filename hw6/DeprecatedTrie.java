...
public class DeprecatedTrie {
    ...
    /* for board */
    public DeprecatedTrie(DeprecatedTrie dict) {
    ...
    /* for board */
    void addPosition(int position, char ch, Node parentNode, DeprecatedTrie dict) {
    ...
    static class Node {
        ...
        private Node(int position, char ch, Node preNode, DeprecatedTrie dict) {
        ...
        void addNextPositionAndCheck(int nextPosition, char character, DeprecatedTrie dict) {
        ...
        private boolean neighborPrefixCheck(DeprecatedTrie dict) {
