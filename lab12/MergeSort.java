...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        // Your code here!
        Queue<Queue<Item>> outside = new Queue<>();
        for (Item singleItem : items) {
            Queue<Item> inside = new Queue<>();
            inside.enqueue(singleItem);
            outside.enqueue(inside);
        }
        return outside;
    }
    ...
    private static <Item extends Comparable> Queue<Item> mergeSortedQueues(
        ...
        while ((!q1.isEmpty()) || (!q2.isEmpty())) {
            merge.enqueue(MergeSort.getMin(q1, q2));
        }
        return merge;
    }
    ...
    public static void main(String[] args) {
        ...
        Queue<String> studentsSorts = MergeSort.mergeSort(students);
