...
public class Plip extends Creature {
    ...
    /* for move and stay action */
    private final double moveEnergy = -0.15, stayEnergy = 0.2;

    private final double maxEnergy = 2;
    private final double coefficient = (double) (255 - 63) / maxEnergy, constant = 63;
    ...
    public Color color() {
        r = 99;
        b = 76;
        g = (int) (coefficient * energy + constant);
        return color(r, g, b);
    }
    ...
    public Action chooseAction(Map<Direction, Occupant> neighbors) {
        ...
        } else if (!clorus.isEmpty() && HugLifeUtils.random() < moveProbability) {
